...
class select:
    ...
    def join(self, model=None, condition=None, type = None):
        ...
        if self._join_model == None or self._joinon == None:
    ...
    def __compute_fields(self, filtered_data):
        ...
        for index, field in enumerate(self._field):
            temp_index.append(filtered_data.columns[f'{field._name}'])
            temp_meta[f'{field._name}'] = index
